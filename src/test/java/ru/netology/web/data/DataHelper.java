...
public class DataHelper {
    ...
    public static CardInfo getInvalidCardOwnerNameIfNumericAndSpecialCharacters() {
        return new CardInfo("4444 4444 4444 4441",  monthWhenEndOfAction, yearWhenEndOfAction, "55%444!$", cvc);
    }

    public static CardInfo getInvalidCardHolderNameIfRussianLetters() {
        return new CardInfo("4444 4444 4444 4441",  monthWhenEndOfAction, yearWhenEndOfAction, "Иван Иванов", cvc);
    }
